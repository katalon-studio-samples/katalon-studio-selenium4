...
import org.openqa.selenium.devtools.v101.emulation.Emulation as Emulation
...
latitude = driver.findElement(By.cssSelector('#latitude'))
longitude = driver.findElement(By.cssSelector('#longitude'))

WebUI.verifyMatch(latitude.getText(), '52.5043', false)
WebUI.verifyMatch(longitude.getText(), '13.4501', false)
